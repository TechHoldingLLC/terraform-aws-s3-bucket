...
| <a name="input_block_http_request"></a> [block\_http\_request](#input\_block\_http\_request) | block HTTP request in a bucket | `bool` | `true` | no |
| <a name="input_bucket_policy"></a> [bucket\_policy](#input\_bucket\_policy) | Custom bucket policy | `any` | `null` | no |
